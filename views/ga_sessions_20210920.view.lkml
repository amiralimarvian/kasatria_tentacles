view: ga_sessions_20210920 {
  sql_table_name: `212020946.ga_sessions_20210920`
    ;;
  ...
  dimension: privacy_info__ads_storage {
    type: string
    sql: ${TABLE}.privacyInfo.ads_storage ;;
  ...
  dimension: privacy_info__analytics_storage {
    type: string
    sql: ${TABLE}.privacyInfo.analytics_storage ;;
    group_label: "Privacy Info"
...
view: ga_sessions_20210920__hits {
  ...
  dimension: uses_transient_token {
    type: string
    sql: ${TABLE}.uses_transient_token ;;
  }
}

view: ga_sessions_20210920__hits__product {
  dimension: custom_dimensions {
    hidden: yes
    sql: ${TABLE}.customDimensions ;;
  }
...
view: ga_sessions_20210920__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20210920__hits__promotion {
...
view: ga_sessions_20210920__hits__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20210920__hits__custom_variables {
...
view: ga_sessions_20210920__hits__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20210920__hits__experiment {
...
view: ga_sessions_20210920__hits__publisher_infos {
...
view: ga_sessions_20210920__hits__product__custom_metrics {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
...
view: ga_sessions_20210920__hits__product__custom_dimensions {
  dimension: index {
    type: number
    sql: ${TABLE}.index ;;
  }
